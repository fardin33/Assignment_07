...
//     const active = "bg-[#224236] text-white shadow-md";

//     const inactive = "text-slate-800 hover:bg-slate-300 hover:text-slate-900";
...
//             <span className="geist text-2xl font-bold  text-[#1F2937]">
//               Keen
//             </span>
//             <span className="geist text-2xl font-bold  text-[#244D3F]">
//               Keeper
//             </span>
//           </NavLink>
//         </div>
...
//           <ul className="geist menu menu-horizontal px-1 gap-2 hidden lg:flex">
//             {navLinks}
//           </ul>
//         </div>
//       </div>
    ...
    <div className="w-full bg-base-100 shadow-sm sticky top-0 z-50">
      <div className="navbar w-11/12 mx-auto px-0">
        ...
        <div className="navbar-start">
          ...
          <NavLink to="/" className="flex items-center cursor-pointer">
            <span className="geist text-[23.5px] md:text-[25.5px] lg:text-[27px] font-bold text-[#1F2937]">
              Keen
            </span>
            <span className="geist text-[23.5px] md:text-[25.5px] lg:text-[27px] font-bold text-[#244D3F]">
              Keeper
            </span>
          </NavLink>
        </div>
