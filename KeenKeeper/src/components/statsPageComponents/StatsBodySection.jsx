...
//   const data = [
//     { name: "Text", value: events.length, color: "#1D3227" },
//     { name: "Call", value: events.length, color: "#7B39FD" },
//     { name: "Video", value: events.length, color: "#34A853" },
//   ];
        ...
        <div className="w-full h-64 md:h-80 flex justify-center items-center">
          {totalEvents > 0 ? (
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Tooltip
                  // Ekhane percentage calculate kore dekhano hoyeche
                  formatter={(value) => [
                ...
                <Pie
                  ...
                  innerRadius="70%"
                  outerRadius="95%"
                  paddingAngle={5} // Gap ektu komiye dewa hoyeche sundor dekhate
                  cornerRadius={10}
                  dataKey="value"
                  stroke="none"
                  startAngle={90}
